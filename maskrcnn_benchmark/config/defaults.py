...
# use rpn only without roi_head
# !!!!!!!!!!!!
_C.MODEL.RPN_ONLY = False
_C.MODEL.MASK_ON = False
# built retinanet or not
# !!!!!!!!!!!!
...
# use for resize during dataset transform
# defaul (800) Changed to 600 for cell detection
_C.INPUT.MIN_SIZE_TRAIN = (600,)  # (800,)
# Maximum size of the side of the image during training
# use for resize during dataset transform
# defaul (1333) Changed to 600 for cell detection
...
# changed to False for cell detection
...
# ---------------------------------------------------------------------------- #
# RPN options (for anchor proposal)
# ---------------------------------------------------------------------------- #
_C.MODEL.RPN = CN()
...
# Custom rpn embed branch, add by ys
_C.MODEL.RPN.RPN_EMBED = "SingleConvRPNEmbed"
_C.MODEL.RPN.RPN_EMBED_DIM = 12
# Custom rpn embed loss, choice {1: contrastive loss, 2: triplet loss}, empty to use default cls and box regression loss
_C.MODEL.RPN.RPN_EMBED_LOSS = 1
_C.MODEL.RPN.RPN_EMBED_MARGIN = 1


# ---------------------------------------------------------------------------- #
# ROI HEADS options (for classification and bbox regression)
# ---------------------------------------------------------------------------- #
...
# changed to 200 for cell detection
...
# choice
# {0: original loss, 1: with contrastive loss, 2: with triplet loss}
_C.MODEL.ROI_BOX_HEAD.LOSS_MODE = 0
...
_C.MODEL.RETINANET.EMBED_ON = False
# 1: PAIR 2: TRIPLET
_C.MODEL.RETINANET.EMBED_LOSS = 2
_C.MODEL.RETINANET.EMBED_DIM = 12
_C.MODEL.RETINANET.EMBED_MARGIN = 1.0
...
# (default 100)changed to 200 for cell detection
