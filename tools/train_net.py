...
from maskrcnn_benchmark.engine.trainer import fit, do_train
...
def train(cfg, local_rank, distributed):
    ...
    # start training: use fit() or do_train()
    # !!!!!!!!!!!!!!!!!!!!!
    do_train(
        model,
        train_loader,
...
def run_test(cfg, model, distributed):
    ...
    data_loaders_val = make_data_loader(cfg, 'test', is_train=False, is_distributed=distributed)
